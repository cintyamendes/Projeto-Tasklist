...
public class TaskController {
	...
	public ResponseEntity<TaskEntity> patchTask(@PathVariable int id, @Valid @RequestBody TaskEntity body) {
	...
	public ResponseEntity<TaskEntity> putTask(@PathVariable int id, @Valid @RequestBody TaskEntity body) {
